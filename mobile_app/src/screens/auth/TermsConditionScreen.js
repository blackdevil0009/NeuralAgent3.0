...
export default function TermsConditionScreen({ navigation }) {
    return (
        <AppScreen title="TermsConditionScreen" showBack={true} navigation={navigation}>
            <DashboardCard 
                title="Page Integration" 
                value="TermsConditionScreen" 
                icon="?" 
            />
