...
export default function DoctorVideoCallScreen({ navigation }) {
    return (
        <AppScreen title="DoctorVideoCallScreen" showBack={true} navigation={navigation}>
            <DashboardCard 
                title="Page Integration" 
                value="DoctorVideoCallScreen" 
                icon="?" 
            />
