...
export default function DoctorUpdateMobileScreen({ navigation }) {
    return (
        <AppScreen title="DoctorUpdateMobileScreen" showBack={true} navigation={navigation}>
            <DashboardCard 
                title="Page Integration" 
                value="DoctorUpdateMobileScreen" 
                icon="?" 
            />
