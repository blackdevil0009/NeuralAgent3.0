...
export default function DoctorSecuritySettingsScreen({ navigation }) {
    return (
        <AppScreen title="DoctorSecuritySettingsScreen" showBack={true} navigation={navigation}>
            <DashboardCard 
                title="Page Integration" 
                value="DoctorSecuritySettingsScreen" 
                icon="?" 
            />
