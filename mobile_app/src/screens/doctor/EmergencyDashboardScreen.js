...
export default function EmergencyDashboardScreen({ navigation }) {
    return (
        <AppScreen title="EmergencyDashboardScreen" showBack={true} navigation={navigation}>
            <DashboardCard 
                title="Page Integration" 
                value="EmergencyDashboardScreen" 
                icon="?" 
            />
