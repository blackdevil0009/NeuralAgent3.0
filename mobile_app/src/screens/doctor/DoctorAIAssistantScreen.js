...
export default function DoctorAIAssistantScreen({ navigation }) {
    return (
        <AppScreen title="DoctorAIAssistantScreen" showBack={true} navigation={navigation}>
            <DashboardCard 
                title="Page Integration" 
                value="DoctorAIAssistantScreen" 
                icon="?" 
            />
