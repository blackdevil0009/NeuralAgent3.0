...
export default function HospitalLayoutScreen({ navigation }) {
    return (
        <AppScreen title="HospitalLayoutScreen" showBack={true} navigation={navigation}>
            <DashboardCard 
                title="Page Integration" 
                value="HospitalLayoutScreen" 
                icon="?" 
            />
