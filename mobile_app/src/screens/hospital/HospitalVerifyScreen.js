...
export default function HospitalVerifyScreen({ navigation }) {
    return (
        <AppScreen title="HospitalVerifyScreen" showBack={true} navigation={navigation}>
            <DashboardCard 
                title="Page Integration" 
                value="HospitalVerifyScreen" 
                icon="?" 
            />
