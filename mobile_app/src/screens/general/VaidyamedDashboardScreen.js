...
export default function VaidyamedDashboardScreen({ navigation }) {
    return (
        <AppScreen title="VaidyamedDashboardScreen" showBack={true} navigation={navigation}>
            <DashboardCard 
                title="Page Integration" 
                value="VaidyamedDashboardScreen" 
                icon="?" 
            />
