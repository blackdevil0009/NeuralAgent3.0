...
export default function MedicalConsultantScreen({ navigation }) {
    return (
        <AppScreen title="MedicalConsultantScreen" showBack={true} navigation={navigation}>
            <DashboardCard 
                title="Page Integration" 
                value="MedicalConsultantScreen" 
                icon="?" 
            />
