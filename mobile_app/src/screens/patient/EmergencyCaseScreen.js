...
export default function EmergencyCaseScreen({ navigation }) {
    return (
        <AppScreen title="EmergencyCaseScreen" showBack={true} navigation={navigation}>
            <DashboardCard 
                title="Page Integration" 
                value="EmergencyCaseScreen" 
                icon="?" 
            />
