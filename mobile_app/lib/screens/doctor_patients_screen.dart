...
class _DoctorPatientsScreenState extends State<DoctorPatientsScreen> {
  ...
  final List<Map<String, dynamic>> _appointments = [
    {'id': 101, 'patientName': 'Riya Mehta', 'date': '06 May 2026', 'time': '10:00 AM', 'type': 'Chat Consultation', 'status': 'Confirmed', 'notes': 'Persistent cough and mild fever for 3 days.', 'conditions': 'Asthma', 'medications': 'Salbutamol', 'allergies': 'Penicillin', 'dosha': 'Vata'},
    {'id': 102, 'patientName': 'Arjun Verma', 'date': '06 May 2026', 'time': '11:00 AM', 'type': 'Offline / In-Clinic', 'status': 'Scheduled', 'notes': 'Knee pain after running.', 'conditions': 'None', 'medications': 'None', 'allergies': 'None', 'dosha': 'Pitta'},
    {'id': 103, 'patientName': 'Sunita Rao', 'date': '06 May 2026', 'time': '01:00 PM', 'type': 'Chat Consultation', 'status': 'Scheduled', 'notes': 'Routine checkup.', 'conditions': 'Hypertension', 'medications': 'Amlodipine', 'allergies': 'Sulfa drugs', 'dosha': 'Kapha'},
    {'id': 104, 'patientName': 'Deepak Sharma', 'date': '05 May 2026', 'time': '03:00 PM', 'type': 'Offline / In-Clinic', 'status': 'Completed', 'notes': 'Diabetes follow-up.', 'conditions': 'Type 2 Diabetes', 'medications': 'Metformin', 'allergies': 'None', 'dosha': 'Kapha'},
  ];
                  ...
                  children: [
                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: const Text('Contact', style: TextStyle(fontFamily: 'Poppins', fontSize: 12)),
                        style: OutlinedButton.styleFrom(padding: const EdgeInsets.symmetric(vertical: 12), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
                      ),
                    ),
                  ],
